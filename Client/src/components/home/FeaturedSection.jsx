    ...
    <>
      ...
      <div className="max-w-6xl mx-auto mt-16">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#fae8e8]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
              viewBox="0 0 32 32"
            >
              <path
            ...
            <div>
              <h3 className="text-[#de8a8d] text-xl font-semibold mb-3">
                Customization
              </h3>
          ...
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#e3f2e6]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
            ...
            <div>
              <h3 className="text-[#79df7e] text-xl font-semibold mb-3">
                Security
              </h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#f2e7e3]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
            ...
            <div>
              <h3 className="text-[#e5d3c0] text-xl font-semibold mb-3">
                Support
              </h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#fef9c4]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
            ...
            <div>
              <h3 className="text-[#e4cd4c] text-xl font-semibold mb-3">
                Performance
              </h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#d4edf8]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
            ...
            <div>
              <h3 className="text-[#3a8fb6] text-xl font-semibold mb-3">
                Global Reach
              </h3>
              <p className="text-gray-600 text-sm">
                Tailor our product to suit your needs Expand your reach with our
          ...
          <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300 bg-[#eeeeee]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="w-12 h-12 bg-[#06064087] p-3 rounded-lg shrink-0"
            ...
            <div>
              <h3 className="text-[#646464] text-xl font-semibold mb-3">
                Communication
              </h3>
              <p className="text-gray-600 text-sm">
